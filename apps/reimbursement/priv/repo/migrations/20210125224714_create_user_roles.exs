defmodule Reimbursement.Repo.Migrations.CreateUserRoles do
  use Ecto.Migration
  ...
  def change do
    create table(:users_roles) do
      ...
      add :reviewer_id, references(:users, prefix: user_prefix(Application.get_env(:reimbursement, :env)), null: false)
