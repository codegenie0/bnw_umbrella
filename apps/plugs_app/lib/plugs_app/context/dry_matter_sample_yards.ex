defmodule PlugsApp.DryMatterSampleYards do
  ...
  @topic "plugs_app:dry_matter_sample_yard"
  ...
  def change_plug(%DryMatterSampleYard{} = plug, attrs \\ %{}) do
    DryMatterSampleYard.changeset(plug, attrs)
  end

  @doc """
  Validation function used by the modal. Verifies valid date
  """
  def validate(%DryMatterSampleYard{} = plug, attrs \\ %{}) do
    plug
    |> change_plug(attrs)
  ...
  """
  def create_or_update_plug(%DryMatterSampleYard{} = plug, attrs \\ %{}) do
    plug
    |> DryMatterSampleYard.changeset(attrs)
    |> Repo.insert_or_update()
    |> notify_subscribers([:dry_matter_sample_yard, :created_or_updated])
  end

  @doc """
  Delete a plug then notify others of its departure
  """
  def delete_plug(%DryMatterSampleYard{} = plug) do
    Repo.delete(plug)
    |> notify_subscribers([:dry_matter_sample_yard, :deleted])
  end
