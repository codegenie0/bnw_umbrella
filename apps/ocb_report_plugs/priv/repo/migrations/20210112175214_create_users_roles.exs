defmodule OcbReportPlugs.Repo.Migrations.CreateUsersRoles do
  use Ecto.Migration

  def change do
    create table(:users_roles) do
      add :user_id, references(:users, prefix: user_prefix(Application.get_env(:ocb_report_plugs, :env)), on_delete: :delete_all, null: false)
