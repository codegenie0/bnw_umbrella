defmodule BnwDashboardWeb.CihReportPlugs.Users.UsersLive do
  @moduledoc """
  ...
  alias BnwDashboardWeb.CihReportPlugs.Users.UserLive
  ...
  def mount(_params, session, socket) do
    ...
    |> assign(socket,
              page_title: "BNW Dashboard · CIH Plugs Users",
