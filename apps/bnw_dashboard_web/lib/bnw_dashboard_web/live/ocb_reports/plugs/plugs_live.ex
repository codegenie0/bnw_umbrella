defmodule BnwDashboardWeb.OcbReportPlugs.Plugs.PlugsLive do
  @moduledoc """
  ### Live view for the OCB report plugs page.
  This document renders the main OCB report page and handles changes to it such as adding, removing, or changing a plug.
  """
  use BnwDashboardWeb, :live_view

  alias BnwDashboardWeb.OcbReportPlugs.Plugs.ChangePlugComponent
  ...
  def mount(_, session, socket) do
    socket = assign_defaults(session, socket)
      |> fetch_plugs()
      |> assign(page_title: "BNW Dashboard · OCB Plugs",
                modal: nil,
                changeset: nil,
