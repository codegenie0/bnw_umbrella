defmodule BnwDashboardWeb.PlugsApp.Users.UsersLive do
  use BnwDashboardWeb, :live_view

  alias BnwDashboardWeb.PlugsApp.Users.UserLive
  alias PlugsApp.{
    Authorize,
    Roles,
    Users
  ...
  defp get_role(socket) do
    ...
    if current_user do
      Authorize.authorize(current_user, "users")
    else
      ""
    end
  end
  ...
  def mount(_params, session, socket) do
    ...
    |> assign(socket,
              page_title: "BNW Dashboard · Plugs Users",
              app: "Plugs",
              search: "")
  ...
  def handle_params(_params, _uri, socket) do
    ...
    socket =
      socket
      |> assign(page_title: "BNW Dashboard · Plugs Users",
                app: "Plugs",
